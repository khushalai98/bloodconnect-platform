...
export default function Register() {
  ...
  const handleActivate = async () => {
    ...
    const user = {
      ...
      trustScore: 0,
      eligible,
      nextEligible: eligible ? null : new Date(lastDate.getTime() + 90 * 86400000).toLocaleDateString('en-IN')
    }
    login(user)
    navigate('/donor')
  }
        ...
        <div className="auth-left">
          <Link to="/" className="auth-logo">
            ...
            <div>
              ...
              <div className="auth-brand-sub">Donor Registration</div>
            </div>
          </Link>
          ...
          <div className="auth-form-card">
            ...
            {step === 1 && (
              <>
                ...
                <p className="auth-subtitle">Step 1 of 4 — Personal Information</p>
