...
const DEMO_USERS = {
  'donor@bloodconnect.in': { id: 'demo-donor-001', name: 'Arjun Sharma', role: 'donor', bloodGroup: 'O+', city: 'Mumbai', trustScore: 87 },
  'hospital@bloodconnect.in': { id: 'demo-hosp-001', name: 'Dr. Priya Nair', role: 'hospital', hospital: 'Apollo Hospital', city: 'Mumbai' },
  'bank@bloodconnect.in': { id: 'demo-bank-001', name: 'Ravi Kumar', role: 'blood-bank', bankName: 'LifeSource Blood Bank', city: 'Delhi' },
  'admin@bloodconnect.in': { id: 'demo-admin-001', name: 'Admin', role: 'admin' },
}
